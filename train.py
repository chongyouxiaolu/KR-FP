...
def train(args, category, rotate_90=False, random_rotate=0):
    ...
    while flag:
        for _, sample_batched in enumerate(dataloader):
            ...
            if args.fp == True:
                if category in ['metal_nut', 'zipper', 'cable', 'hazelnut', 'screw']:
                    fp = 0.3
                elif category in ['pill']:
                    fp = 0.4
                elif category in ['capsule', 'tile', 'toothbrush', 'wood', 'leather']:
                    fp = 0.5
                elif category in ['carpet']:
                    fp = 0.7
                elif category in ['transistor','bottle', 'grid' ]:
                    fp = 0
            else:
                fp = 0
...
if __name__ == "__main__":
    ...
    # parser.add_argument("--mvtec_path", type=str, default="/public2/home/lak/destseg/datasets/mvtec/")
    # parser.add_argument("--dtd_path", type=str, default="/public2/home/lak/destseg/datasets/dtd/images/")
    parser.add_argument("--mvtec_path", type=str, default="E:\project\defect\destseg\datasets/mvtec/")
    parser.add_argument("--dtd_path", type=str, default="E:\project\defect\destseg\datasets/dtd/images/")
